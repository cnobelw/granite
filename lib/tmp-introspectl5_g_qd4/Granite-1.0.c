...
extern GType granite_application_get_type(void);
extern GType granite_gtk_patch_about_dialog_get_type(void);
extern GType granite_widgets_about_dialog_get_type(void);
extern GType granite_widgets_tool_button_with_menu_get_type(void);
extern GType granite_widgets_app_menu_get_type(void);
extern GType granite_services_settings_serializable_get_type(void);
extern GType granite_drawing_color_get_type(void);
extern GType granite_drawing_buffer_surface_get_type(void);
extern GType granite_drawing_utilities_get_type(void);
extern GType granite_services_settings_get_type(void);
extern GType granite_services_log_level_get_type(void);
extern GType granite_services_logger_get_type(void);
extern GType granite_services_paths_get_type(void);
extern GType granite_services_system_get_type(void);
extern GType granite_services_contractor_get_type(void);
extern GType granite_services_contractor_dbus_proxy_get_type(void);
extern GType granite_services_contractor_dbus_get_type(void);
extern GType granite_services_contract_get_type(void);
extern GType granite_services_contractor_proxy_get_type(void);
extern GType granite_services_icon_factory_get_type(void);
extern GType granite_services_simple_command_get_type(void);
extern GType granite_text_style_get_type(void);
extern GType granite_close_button_position_get_type(void);
extern GType granite_widgets_wrap_label_get_type(void);
extern GType granite_widgets_mode_button_get_type(void);
extern GType granite_widgets_date_picker_get_type(void);
extern GType granite_widgets_hinted_entry_get_type(void);
extern GType granite_widgets_search_bar_get_type(void);
extern GType granite_widgets_time_picker_get_type(void);
extern GType granite_collapse_mode_get_type(void);
extern GType granite_widgets_collapsible_paned_get_type(void);
extern GType granite_widgets_hcollapsable_paned_get_type(void);
extern GType granite_widgets_vcollapsable_paned_get_type(void);
extern GType granite_widgets_static_notebook_get_type(void);
extern GType granite_widgets_tab_get_type(void);
extern GType granite_widgets_tab_page_container_get_type(void);
extern GType granite_widgets_dynamic_notebook_get_type(void);
extern GType granite_widgets_dynamic_notebook_tab_bar_behavior_get_type(void);
extern GType granite_widgets_composited_window_get_type(void);
extern GType granite_widgets_welcome_get_type(void);
extern GType granite_widgets_tool_button_with_menu_vmenu_position_get_type(void);
extern GType granite_widgets_tool_button_with_menu_hmenu_position_get_type(void);
extern GType granite_widgets_pop_over_get_type(void);
extern GType granite_widgets_pop_over_pop_position_get_type(void);
extern GType granite_widgets_contractor_view_get_type(void);
extern GType granite_widgets_contractor_menu_get_type(void);
extern GType granite_widgets_decorated_window_get_type(void);
extern GType granite_widgets_light_window_get_type(void);
extern GType granite_widgets_status_bar_get_type(void);
extern GType granite_widgets_thin_paned_get_type(void);
extern GType granite_widgets_sidebar_paned_get_type(void);
extern GType granite_widgets_source_list_get_type(void);
extern GType granite_widgets_source_list_item_get_type(void);
extern GType granite_widgets_source_list_expandable_item_get_type(void);
extern GType granite_widgets_cell_renderer_expander_get_type(void);
extern GType granite_widgets_cell_renderer_badge_get_type(void);
extern GType granite_widgets_overlay_bar_get_type(void);
GType (*GI_GET_TYPE_FUNCS_[])(void) = {
  granite_application_get_type,
  granite_gtk_patch_about_dialog_get_type,
  granite_widgets_about_dialog_get_type,
  granite_widgets_tool_button_with_menu_get_type,
  granite_widgets_app_menu_get_type,
  granite_services_settings_serializable_get_type,
  granite_drawing_color_get_type,
  granite_drawing_buffer_surface_get_type,
  granite_drawing_utilities_get_type,
  granite_services_settings_get_type,
  granite_services_log_level_get_type,
  granite_services_logger_get_type,
  granite_services_paths_get_type,
  granite_services_system_get_type,
  granite_services_contractor_get_type,
  granite_services_contractor_dbus_proxy_get_type,
  granite_services_contractor_dbus_get_type,
  granite_services_contract_get_type,
  granite_services_contractor_proxy_get_type,
  granite_services_icon_factory_get_type,
  granite_services_simple_command_get_type,
  granite_text_style_get_type,
  granite_close_button_position_get_type,
  granite_widgets_wrap_label_get_type,
  granite_widgets_mode_button_get_type,
  granite_widgets_date_picker_get_type,
  granite_widgets_hinted_entry_get_type,
  granite_widgets_search_bar_get_type,
  granite_widgets_time_picker_get_type,
  granite_collapse_mode_get_type,
  granite_widgets_collapsible_paned_get_type,
  granite_widgets_hcollapsable_paned_get_type,
  granite_widgets_vcollapsable_paned_get_type,
  granite_widgets_static_notebook_get_type,
  granite_widgets_tab_get_type,
  granite_widgets_tab_page_container_get_type,
  granite_widgets_dynamic_notebook_get_type,
  granite_widgets_dynamic_notebook_tab_bar_behavior_get_type,
  granite_widgets_composited_window_get_type,
  granite_widgets_welcome_get_type,
  granite_widgets_tool_button_with_menu_vmenu_position_get_type,
  granite_widgets_tool_button_with_menu_hmenu_position_get_type,
  granite_widgets_pop_over_get_type,
  granite_widgets_pop_over_pop_position_get_type,
  granite_widgets_contractor_view_get_type,
  granite_widgets_contractor_menu_get_type,
  granite_widgets_decorated_window_get_type,
  granite_widgets_light_window_get_type,
  granite_widgets_status_bar_get_type,
  granite_widgets_thin_paned_get_type,
  granite_widgets_sidebar_paned_get_type,
  granite_widgets_source_list_get_type,
  granite_widgets_source_list_item_get_type,
  granite_widgets_source_list_expandable_item_get_type,
  granite_widgets_cell_renderer_expander_get_type,
  granite_widgets_cell_renderer_badge_get_type,
  granite_widgets_overlay_bar_get_type
};
extern GQuark granite_services_contractor_error_quark(void);
GQuark (*GI_ERROR_QUARK_FUNCS_[])(void) = {
  granite_services_contractor_error_quark
};
